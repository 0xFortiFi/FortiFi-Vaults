export const yieldYakSAVAX_ABI = [
    {
        inputs: [
            ...
            { internalType: "address", name: "_timelock", type: "address" },
            {
                components: [
                    ...
                    { internalType: "uint256", name: "adminFeeBips", type: "uint256" },
    ...
    { inputs: [], name: "setAllowances", outputs: [], stateMutability: "nonpayable", type: "function" },
    {
