...
describe("Basic Vector Strategy Tests", function () {
  ...
  it("Check that ERC20 tokens can be deposited and withdrawn", async function () {
    ...
    await Strategy.connect(addr1).withdrawFromFortress(ethers.parseEther("900"), addr1.getAddress(), 1);
